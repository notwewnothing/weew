...
/// generated route for
/// [_i45.CassettePlayerScreen]
class CassettePlayerRoute extends _i41.PageRouteInfo<void> {
  const CassettePlayerRoute({List<_i41.PageRouteInfo>? children})
      : super(CassettePlayerRoute.name, initialChildren: children);

  static const String name = 'CassettePlayerRoute';

  static _i41.PageInfo page = _i41.PageInfo(
    name,
    builder: (data) {
      return const _i45.CassettePlayerScreen();
    },
  );
}

/// generated route for
/// [_i46.VinylPlayerScreen]
class VinylPlayerRoute extends _i41.PageRouteInfo<void> {
  const VinylPlayerRoute({List<_i41.PageRouteInfo>? children})
      : super(VinylPlayerRoute.name, initialChildren: children);

  static const String name = 'VinylPlayerRoute';

  static _i41.PageInfo page = _i41.PageInfo(
    name,
    builder: (data) {
      return const _i46.VinylPlayerScreen();
    },
  );
}
